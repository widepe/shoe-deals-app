...
<head>
  ...
  <style>
    ...
    /* UPDATED: card background + image border for daily deals */
    .daily-deal-card {
      background: rgba(217, 225, 235, 1);
    ...
    .daily-deal-card img {
      ...
      background: #fafafa;
      border: 1px solid #214478ff; /* thin blue border around shoe image */
    }
    ...
    /* UPDATED: card background + image border for search results */
    .card {
      background: rgba(217, 225, 235, 1);
      border: 2px solid #214478ff;
      border-radius: 0.75rem;
    ...
    /* Shoe column - truncate at 30 chars */
    ...
    /* Footer - now scrolls with the page (no fixed positioning) */
    .footer {
      margin-top: 2rem;
      padding: 0.75rem 1rem;
  ...
  <div class="app">
    ...
    <form id="search-form">
      <div class="input-wrapper">
        ...
        <span class="paw rock" id="brandPaw">🐾</span>
      ...
      <div class="input-wrapper">
        ...
        <span class="paw hidden" id="modelPaw">🐾</span>
        <div id="modelSuggestions" class="suggestions"></div>
      </div>

      <div class="button-wrapper">
        <button id="fetchBtn" type="submit" class="search-btn"><span class="magnify-icon">🔍</span> Fetch!</button>
      </div>
    </form>
     ...
     <div class="daily-deals" id="dailyDeals">
        ...
        <div class="daily-deals-grid">
          <div class="daily-deal-card">
            <a href="https://www.runningwarehouse.com/New_Balance_Fresh_Foam_X_1080_v14/descpage-N141M00.html" target="_blank" rel="noopener noreferrer" style="text-decoration: none; color: inherit;">
              <img src="https://img.runningwarehouse.com/watermark/rs.php?path=N141M00-1.jpg&nw=300" alt="New Balance Fresh Foam X 1080 v14">
              <div class="daily-deal-title">New Balance Fresh Foam X 1080 v14</div>
              <div style="font-size: 0.8rem; color: #49543a; margin: 0.2rem 0;">Running Warehouse</div>
              <div class="daily-deal-price">$99.88 <span style="text-decoration: line-through; font-size: 0.8rem; color: #999;">$164.95</span></div>
            </a>
          </div>
          <div class="daily-deal-card">
            <a href="https://www.runningwarehouse.com/New_Balance_FuelCell_Rebel_v4/descpage-NB4REM6.html" target="_blank" rel="noopener noreferrer" style="text-decoration: none; color: inherit;">
              <img src="https://img.runningwarehouse.com/watermark/rs.php?path=NB4REM6-1.jpg&nw=300" alt="New Balance FuelCell Rebel v4">
              <div class="daily-deal-title">New Balance FuelCell Rebel v4</div>
              <div style="font-size: 0.8rem; color: #49543a; margin: 0.2rem 0;">Running Warehouse</div>
              <div class="daily-deal-price">$99.88 <span style="text-decoration: line-through; font-size: 0.8rem; color: #999;">$139.99</span></div>
            </a>
          </div>
          <div class="daily-deal-card">
            <a href="https://www.zappos.com/p/mens-saucony-echelon-9-charcoal-red-sky/product/9733648/color/994739" target="_blank" rel="noopener noreferrer" style="text-decoration: none; color: inherit;">
              <img src="https://m.media-amazon.com/images/I/81LlrWNr6wL._AC_SR300,200_.jpg" alt="Saucony Echelon 9">
              <div class="daily-deal-title">Saucony Echelon 9</div>
              <div style="font-size: 0.8rem; color: #49543a; margin: 0.2rem 0;">Zappos</div>
              <div class="daily-deal-price">$120.00 <span style="text-decoration: line-through; font-size: 0.8rem; color: #999;">$150.00</span></div>
            </a>
          </div>
          <div class="daily-deal-card">
            <a href="https://www.zappos.com/p/mens-on-cloudmonster-all-black/product/9700021/color/8768" target="_blank" rel="noopener noreferrer" style="text-decoration: none; color: inherit;">
              <img src="https://m.media-amazon.com/images/I/715pj6Rsn2L._AC_SR300,200_.jpg" alt="On Cloudmonster">
              <div class="daily-deal-title">On Cloudmonster</div>
              <div style="font-size: 0.8rem; color: #49543a; margin: 0.2rem 0;">Zappos</div>
              <div class="daily-deal-price">$127.50 <span style="text-decoration: line-through; font-size: 0.8rem; color: #999;">$170.00</span></div>
            </a>
          </div>
          <div class="daily-deal-card">
            <a href="https://www.zappos.com/p/mens-hoka-clifton-10/product/9984276" target="_blank" rel="noopener noreferrer" style="text-decoration: none; color: inherit;">
              <img src="https://m.media-amazon.com/images/I/71BkU2gMQ4L._AC_SR300,200_.jpg" alt="Hoka Clifton 10">
              <div class="daily-deal-title">Hoka Clifton 10</div>
              <div style="font-size: 0.8rem; color: #49543a; margin: 0.2rem 0;">Zappos</div>
              <div class="daily-deal-price">$155.00</div>
            </a>
          </div>
        </div>
      </div>
      ...
      <p class="disclaimer">Prices are subject to change. Shoe Beagle does not sell products directly and is not responsible for changes in price, availability, or shipping terms on retailer sites.</p>

      <div class="alert-wrapper" id="alertWrapper" style="display:none;">
        <button class="alert-prompt-btn" id="alertPromptBtn"><span class="bell-icon">🔔</span> Set Price Alert?</button>
        ...
        <div class="alert-form" id="alertForm" style="display:none;">
          ...
          <div class="alert-form-row">
            <div class="price-input-wrapper">
              ...
              <span class="paw rock" id="alertPricePaw">🐾</span>
            </div>
          </div>
          ...
          <div class="alert-privacy-note">🔒 Your information is used only to send you requested price alerts, and is never sold or shared with third parties.</div>

          <button class="alert-submit-btn" id="alertSubmitBtn">
            <span class="envelope-icon">📩</span> Set Price Alert
          </button>
    ...
    <!-- Footer - scrolls with page, no affiliate sentence -->
    <div class="footer">
  ...
  <div id="privacyModal" class="modal-overlay">
    <div class="modal" role="dialog" aria-modal="true" aria-labelledby="privacyTitle">
      <div class="modal-header">
        <img src="/images/logo.svg" alt="Shoe Beagle Logo">
      ...
      <div class="modal-body">
        ...
        <ul>
          ...
          <li>Request that we delete your alert-related information by contacting us at <a href="mailto:widepe@gmail.com">widepe@gmail.com</a>.</li>
        </ul>

        <h3>10. Contact us</h3>
        <p>If you have questions about this Privacy Policy or how we handle your data, you can contact us at: <a href="mailto:widepe@gmail.com">widepe@gmail.com</a>.</p>
      </div>
  ...
  <div id="termsModal" class="modal-overlay">
    <div class="modal" role="dialog" aria-modal="true" aria-labelledby="termsTitle">
      ...
      <div class="modal-body">
        ...
        <h3>11. Contact us</h3>
        <p>If you have questions about these Terms of Use, you can contact us at: <a href="mailto:widepe@gmail.com">widepe@gmail.com</a>.</p>
      </div>
      <div class="modal-close-row">
  ...
  <script>
    ...
    function renderAlertsDashboard() {
      ...
      sorted.forEach(a => {
        ...
        tdShoe.title = shoeText; // Full text on hover
        ...
        tr.addEventListener("click", (e) => {
          ...
          if (status === "Active") {
            ...
            // Add 10 Days - keep date same, just extend days
...
function updateAlertSubmitButton() {
  ...
  alertSubmitBtn.classList.toggle("ready", isReady);
    ...
    form.addEventListener("submit", async (e) => {
      ...
      const existingActive = findActiveAlertFor(brandKey, modelCanonical);
      if (existingActive) {
      ...
      if (!results.length) {
        statusMessageEl.textContent = "No results found — set a price alert and we'll keep sniffing.";
        return;
      }
      ...
      results.forEach(item => {
        ...
        const p = (typeof item.price === "number") ? item.price.toFixed(2) : (item.price ? String(item.price) : "—");
      ...
      // DO NOT clear inputs - keep brand and model
    });
    ...
    alertSubmitBtn.addEventListener("click", async () => {
      ...
      alertConfirmation.innerHTML = `
        ...
        Manage it anytime in <strong>My Alerts</strong>.
      `;
      alertConfirmation.style.display = "block";
    });
  </script>
